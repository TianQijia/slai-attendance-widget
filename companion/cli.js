...
async function connectionInfo(dir, host) {
  ...
  const help = '<section><h2>再次查看</h2><p>手机页面顶部可勾选“在此浏览器记住查看权限”，方便关闭后重新打开。缺少权限时，可在手机顶部重新粘贴上方完整查看链接。请勿粘贴本机配对码。</p><p>手机顶部“刷新”立即读取电脑端最新结果。自动复制不可用时，长按弹出的报告文本框，选择“全选／复制”。</p></section><section><h2>网络检测</h2><p>手机打不开时，双击 companion 文件夹内的 diagnose.command（Mac）或 diagnose.cmd（Windows）。检测会打开可复制的脱敏报告；服务未启动时也能运行。</p><p>检测只读取状态，不更改网络和防火墙。校园网是否允许设备互访，仍需手机访问确认。</p></section>';
